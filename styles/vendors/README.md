...
Slight modification from what originaly `vendors/` directory means in `7-1`.
We import most libs from `node_modules` anyway, in this case put the `@import` directives in `lib.sass`.
